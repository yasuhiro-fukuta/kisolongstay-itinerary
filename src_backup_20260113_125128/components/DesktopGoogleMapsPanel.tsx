...
export default function DesktopGoogleMapsPanel({
  ...
  const showPredList = open && (predLoading || predictions.length > 0);
  const showResults = mode !== "none";

  return (
    <div
      ref={rootRef}
      className="absolute left-0 top-0 bottom-0 z-[70] w-[380px] max-w-[92vw] bg-white text-neutral-900 shadow-2xl border-r border-neutral-200 pointer-events-auto"
    >
